...
faces = {
    ...
    'c' : {
        ...
        'centers' : { 'rect' : { 'chrono_minute': (115, 84),
                      ...
                      'emery' : { 'chrono_minute' : (158, 114),
                                  ...
                                  'second' : (42, 114), },
                      'gabbro' : { 'chrono_minute' : (195, 130),
                                   'chrono_tenth' : (130, 195),
                                   'second' : (65, 130), },
                      },
        ...
        'date_window_a_gabbro' : [(64, 52, 'b'), (27, 173, 'b')],
        'date_window_b_gabbro' : [(135, 52, 'b'), (171, 173, 'b')],
        'date_window_filename' : ('date_window.png', 'date_window_mask.png'),
        'top_subdial_rect' : (32, 16, 'b'),
        'top_subdial_round' : (50, 20, 'b'),
        'top_subdial_emery' : (50, 22, 'b'),
        'top_subdial_gabbro' : (80, 30, 'b'),
        ...
        'bluetooth_gabbro' : (48, 59, 'b'),
        'battery_gabbro' : (176, 71, 'b'),
    ...
    'd' : {
        ...
        'date_window_a_gabbro' : [(55, 133, 'w'), (55, 133, 'b'), (55, 133, 'w')],
        'date_window_b_gabbro' : [(143, 133, 'w'), (143, 133, 'b'), (143, 133, 'w')],
        'date_window_c_gabbro' : [(66, 166, 'w'), (66, 166, 'b'), (66, 166, 'w')],
        'date_window_d_gabbro' : [(132, 166, 'w'), (132, 166, 'b'), (132, 166, 'w')],
        'date_window_filename' : ('date_window.png', 'date_window_mask.png'),
        ...
        'top_subdial_gabbro' : [(80, 49, 'w'), (80, 49, 'b'), (80, 49, 'w')],
        ...
        'bluetooth_gabbro' : [ (88, 69, 'b'), (66, 62, 'b'),
                               (88, 69, 'b'), (66, 62, 'b'),
                               (88, 69, 'b'), (66, 62, 'b'),
                              ],
        'battery_gabbro' : [ (141, 75, 'b'), (168, 68, 'b'),
                             (141, 75, 'b'), (168, 68, 'b'),
                             (141, 75, 'b'), (168, 68, 'b'),
                            ],
    ...
    'e' : {
        ...
        'date_window_a_gabbro' : (99, 16, 'w'),
        'date_window_b_gabbro' : (16, 113, 'w'),
        'date_window_c_gabbro' : (184, 113, 'w'),
        'date_window_d_gabbro' : (99, 208, 'w'),
        'date_window_filename' : ('date_window.png', 'date_window_mask.png'),
        'top_subdial_rect' : (32, 32, 'b'),
        'top_subdial_round' : (50, 32, 'b'),
        'top_subdial_emery' : (50, 43, 'b'),
        ...
        'bluetooth_gabbro' : [ (38, 38, 'b'), (38, 38, 'w'), (38, 38, 'b'), ],
        'battery_gabbro' : [ (194, 43, 'b'), (194, 43, 'w'), (194, 43, 'b'), ],
